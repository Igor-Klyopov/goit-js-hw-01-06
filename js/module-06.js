...
// console.log(one.every(el => 3)); // true
// console.log(two.every(el => 3)); // true!!!
// console.log(one.some(el => 3)); // true
// console.log(two.some(el => 3)); //false
// console.log(one.find(el => el === 3)); //3
// console.log(two.find(el => el === 3)); //undefined
// console.log(one.filter(el => el === 3)); //[3]
// console.log(two.filter(el => el === 3)); //[]
// console.log(one.includes(3)); // true
// console.log(two.includes(3)); //false

// const three = [5, 8, 2, 4, 5, 3, 8, 7, 2, 8, 9, 3];
// console.log(three.sort());
// console.log(three.sort((a, b) => b - a));
...
// const topRatedBooks = books.filter(book => book.rating >= MIN_RATING);//books.filter(({rating}) => rating >= MIN_RATING)
// const booksByAuthor = books.filter(book => book.author === AUTHOR);//books.filter(({author}) => author === AUTHOR)
...
//   users.filter(user => user.eyeColor === color); //users.filter(({eyeColor}) => eyeColor === color)
// // Пиши код выше этой строки
...
//   users.filter(({ age }) => age >= minAge && age <= maxAge); //users.filter(user => user.age >= minAge && user.age <= maxAge)
// // Пиши код выше этой строки
...
//   users.filter(({ friends }) => friends.includes(friendName)); //users.filter(user => user.friends.includes(friendName))
// // Пиши код выше этой строки
...
//   users
//     .flatMap(user => user.friends)
//     .filter((userName, index, users) => users.indexOf(userName) === index)
//     .sort((firstuserName, seconduserName) =>
//       firstuserName.localeCompare(seconduserName),
//     );
// // Пиши код выше этой строки
// console.log(
//   getSortedFriends([
...
//     .reduce((acc, userBalance) => (acc += userBalance), 0);
